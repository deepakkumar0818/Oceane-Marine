...
export default function NewBaseSetupChecklistListPage() {
  ...
  const handleDownload = async (form) => {
    ...
    try {
      ...
      let fileName = `new-base-setup-checklist-v${form.version}.docx`;
      ...
      <div className="mx-auto max-w-[95%] pl-4 pr-4 py-10 space-y-6">
        <header className="flex items-center justify-between gap-4 flex-wrap">
          <div>
            ...
            <h1 className="text-2xl font-bold">New Base Setup Checklists</h1>
            <p className="text-xs text-slate-200 mt-1">
              View and manage all new base setup checklists
            </p>
          </div>
        ...
        <main>
          {forms.length === 0 ? (
            <div className="text-center py-12 rounded-2xl border border-white/10 bg-white/5">
              ...
              <p className="text-white/60 mb-2">No checklists found</p>
