export const POAC_EVALUATION_ITEMS = [
  // Prior to commencement of Operations (1-9)
  {
    srNo: 1,
    area: "Suitability of vessels checked. (Mooring plans, STS plans and Q88s reviewed)",
  },
  ...
  {
    srNo: 7,
    area: "Suitable anchoring location with regard to vessel draft etc",
  },
  ...
  {
    srNo: 22,
    area: "Readiness to heave up anchor /Readiness of Mooring stations",
  },
  { srNo: 23, area: "Navigation warning broadcast" },

  // Approach and mooring operation (24-42)
  {
    srNo: 24,
    area: "Safety Meeting conducted with crew. (Including snap back zone awareness)",
  },
  ...
  {
    srNo: 28,
    area: "Discussed emergency procedures and ME speed -Manoeuvring",
  },
  { srNo: 29, area: "OCIMF Checklist complied with" },
  { srNo: 30, area: "Proper handover of command" },
  {
    srNo: 31,
    area: "Communication with bridge team / exchange of information",
  },
  ...
  {
    srNo: 46,
    area: "Cargo hazard precautions explained to crew. (i.e., H2S monitors for personnel)",
  },
  { srNo: 47, area: "MSDS for the cargo obtained" },
  { srNo: 48, area: "Hose String and gasket connections" },

  // Cargo operations (49-51)
  {
    srNo: 49,
    area: "Safety Meeting conducted with crew. (Including instruction to regularly tend vessel and fender moorings)",
  },
  { srNo: 50, area: "OCIMF STS Checklists complied" },
  { srNo: 51, area: "Deck rounds and Manifold pressure monitored" },

  // Hose draining and disconnection (52-56)
  ...
  {
    srNo: 56,
    area: "Informed office to arrange support craft for demobilisation",
  },
  ...
  // Office Requirements (72-75)
  { srNo: 72, area: "Regular operational updates" },
  {
    srNo: 73,
    area: "Timely reporting of issues (Advisement of issues in good time to allow for prompt action)",
  },
  { srNo: 74, area: "General communication with Operations Team" },
  {
    srNo: 75,
    area: "Correctly completing and efficiently submitting STS documentation",
  },
];
